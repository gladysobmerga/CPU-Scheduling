...
public class ReadyChart {
    private static int readyX = 532; // start drawing point on x-coordinate
    private static final int readyY = 599; // ready queue Chart location on y-coordinate
    public static ArrayList<Cell> List = new ArrayList<Cell>(10); // list of ready queue jobs' represnation  
    ...
    public static void update(Queue jobList){
        ...
        for(int i=0 ; i<jobList.size() ; i++)
        {
            ...
            readyX += 30; // set next job location
        }
    }
    ...
    public static void clear(){
         List.clear();
         readyX = 532; // start locatoin on x-coordinate
     }
}
